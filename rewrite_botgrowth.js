...
const script = `import { EmbedBuilder, ActionRowBuilder, StringSelectMenuBuilder, ButtonBuilder, ButtonStyle, ModalBuilder, TextInputBuilder, TextInputStyle, InteractionType } from 'discord.js';
...
fs.writeFileSync("src/commands/botgrowth.js", script);
console.log("Rewrote botgrowth.js");
