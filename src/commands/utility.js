...
const helpModules = [
  ...
  { id: 'links', label: 'Link & Invite Filters', emoji: '<:link_invite_threads:1523770849197428837>', commands: ['`!antilink` **on** / **off** — Block all external links from non-moderators `[extra owners]`', '`!linksallow` **add** / **remove** / **list** `domain` — Whitelist specific domains `[extra owners]`', '`!blacklist` **add** / **remove** / **list** `phrase` — Auto-delete matching phrases `[extra owners]`'] },
  ...
  { id: 'music', label: 'Music Player', emoji: '<:music_player:1523770740476739809>', commands: ['`/setupmusic` `[image_url]` — Create the Compact Music Player channel `[extra owners]`', '`/play` `query` — Play a song in your voice channel via URL or search `[public]`', 'Use the dedicated Music Console channel to control playback (Play, Pause, Skip, Queue, Stop).'] },
  ...
  { id: 'verification', label: 'Verification & Tickets', emoji: '<:verification_and_ticket:1523770653528817835>', commands: ['`/verify setup` `@role` — Deploy the server verification panel `[extra owners]`', '`/verify disable` — Remove the verification system `[extra owners]`', '`/ticket setup` `#category` `@role` — Deploy the support ticket panel `[extra owners]`'] },
  ...
  { id: 'autoresponder', label: 'Auto-Responder', emoji: '<:auto_responder:1523770799603847179>', commands: ['`!trigger` **create** `match | response` — Add a custom keyword trigger `[extra owners]`', '`!trigger` **remove** `match` — Delete a trigger `[extra owners]`', '`!trigger` **list** — View all active triggers in this server `[extra owners]`'] },
