...
const helpModules = [
  ...
  { id: 'tts', shortLabel: 'TTS', label: 'Text to Speech System', emoji: '<:voice_join_to_create:1523770607706308658>', commands: ['`!tts` `<message>` / **stop** - Speak in VC `[public]`', '`!tts` **lang** / **voice** - Change your voice profile `[public]`', '`!tts` **auto** / **unauto** `[@user]` - Lock user to Auto-TTS `[public/admin]`', '`!tts` **autovc** - Toggle global Auto-TTS for your current VC `[admin]`'] },
