...
const helpModules = [
  ...
  { id: 'actions', category: 'COMMUNITY & ENGAGEMENT', shortLabel: 'Roleplay', label: 'Roleplay Actions', emoji: 'actions', commands: ["`!hug / !kiss / !slap / !pat / !bite / !cuddle / !wink / !bonk / !bully / !cry / !handhold / !highfive / !nom / !poke` - Interact with users `[public]`","`!date @user` - Go on a date `[public]`", "`!chess` - Play Chess against Cloud Stockfish or a friend `[public]`", "`!starboard setup` - Configure the starboard system `[admin]`", "`!suggest` - Submit a server suggestion `[public]`", "`!setsuggestions` - Set the suggestion channel `[admin]`", "`!ratelb / !editlb` - View the top rated edits `[public]`"] },
