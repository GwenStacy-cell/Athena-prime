...
const helpModules = [
  ...
  { id: 'welcome', category: 'SERVER ADMINISTRATION', shortLabel: 'Welcome', label: 'Welcome System', emoji: 'welcome', commands: ["`!welcome setup` - Build interactive welcome messages `[extra owners]`","`!autorole add @role` - Automatically assign roles on join `[extra owners]`"] },
