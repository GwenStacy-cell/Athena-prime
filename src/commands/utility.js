...
const helpModules = [
  ...
  { id: 'config', category: 'SERVER ADMINISTRATION', shortLabel: 'Config', label: 'Customization & Roles', emoji: 'config', commands: ["`!prefix <new>` - Change bot prefix `[extra owners]`", "`!accent` - Modify embed colors `[extra owners]`", "`!autonick on` - Standardize member nicknames `[extra owners]`", "`!rrsetup` - Setup Reaction Roles `[extra owners]`"] },
  ...
  { id: 'tickets', category: 'UTILITIES & INTEGRATIONS', shortLabel: 'Tickets', label: 'Support Tickets', emoji: 'tickets', commands: ["`!ticket` - Launch Ticket Panel Builder `[extra owners]`", "`!close` - Close active ticket thread `[public]`", "`!ticketpanel` - Launch interactive ticket panel manager `[extra owners]`", "`!ticket` - Manage the ticket system `[public]`"] },
