...
const helpModules = [
  ...
  { id: 'verification', shortLabel: 'Tickets', label: 'Verification & Tickets', emoji: '<:verification_and_ticket:1523770653528817835>', commands: ['**Verification**', '`/verify setup` `@role` — Deploy the server verification panel `[extra owners]`', '`/verify disable` — Remove the verification system `[extra owners]`', '', '**Default Ticket System**', '`!ticket setup` `#category` `@role` — Deploy a simple, single-button ticket system `[extra owners]`', '', '**Custom Ticket Panel**', '`!ticketpanel` — Spawns the Interactive Ticket Manager. Click the buttons to easily add custom dropdown options, titles, and images without typing complex commands! `[extra owners]`'] },
