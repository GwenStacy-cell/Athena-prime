...
const helpModules = [
  ...
  { id: 'tracking', category: 'SERVER ADMINISTRATION', shortLabel: 'Tracking', label: 'Engagement & Tracking', emoji: 'tracking', commands: ["`!serverlogs autosetup` - Setup Advanced Logging `[extra owners]`","`!invitesetup #channel` - Advanced Invite Tracker `[extra owners]`","`!record start` - Live VC audio recording `[extra owners]`","`!audit` / `!logs` - Server logging toggles `[extra owners]`"] },
  { id: 'config', category: 'SERVER ADMINISTRATION', shortLabel: 'Config', label: 'Customization & Roles', emoji: 'config', commands: ["`!prefix <new>` - Change bot prefix `[extra owners]`","`!accent` - Modify embed colors `[extra owners]`","`!autonick on` - Standardize member nicknames `[extra owners]`"] },
  ...
  { id: 'stats', category: 'COMMUNITY & ENGAGEMENT', shortLabel: 'Stats', label: 'Statistics', emoji: 'stats', commands: ["`!me` - View personal message stats `[public]`","`!top` - Combined server leaderboard `[public]`","`!server` / `!serveroverview` - Graphical stats overview `[public]`","`!userinfo @user` - View profile information `[public]`"] },
  ...
  { id: 'tickets', category: 'UTILITIES & INTEGRATIONS', shortLabel: 'Tickets', label: 'Support Tickets', emoji: 'tickets', commands: ["`!ticket` - Launch Ticket Panel Builder `[extra owners]`","`!close` - Close active ticket thread `[public]`"] },
