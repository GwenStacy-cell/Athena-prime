...
const helpModules = [
  ...
  { id: 'voice', shortLabel: 'Voice', label: 'Voice & Join-to-Create', emoji: '<:voice_join_to_create:1523770607706308658>', commands: ['`!theatermode` **on/off** — Activates Movie Mode (Server mutes/deafens the entire VC) `[extra owners]`', '`!vclock` / `!vcunlock` — Deny or restore Connect permissions for @everyone in your VC `[extra owners]`', '`!mute` / `!unmute` / `!deafen` / `!undeafen` — VC member state control `[extra owners]`', '`!muteall` / `!unmuteall` / `!deafenall` / `!undeafenall` — Mass VC state control `[extra owners]`', '`!jtcsetup` `#voicechannel` — Designate the JTC creator channel `[extra owners]`', '`!jtcdisable` — Remove the JTC system from this server `[extra owners]`', '`!vc` — Manage your personal JTC channel (rename, limit, privacy...) `[public]`', '`!sethomevc` `[channel]` — Set bot\'s Home VC (auto-rejoin if moved) `[extra owners]`', '`!unsethomevc` — Clear Home VC and disconnect the bot `[extra owners]`'] },
