...
const helpModules = [
  ...
  { id: 'actions', category: 'COMMUNITY & ENGAGEMENT', shortLabel: 'Roleplay', label: 'Roleplay Actions', emoji: 'actions', commands: ["`!hug / !kiss / !slap / !pat` - Interact with users `[public]`","`!date @user` - Go on a date `[public]`"] },
