...
export async function getWhitelistPanel(guild, targetId, type, view = 'info') {
  ...
  const modLabels = {
    antiRoleCreate: 'Anti Role Create [~120ms WSS] [Reactive Strike]',
    antiRoleDelete: 'Anti Role Delete [~45ms API] [Instant Strike]',
    antiRoleUpdate: 'Anti Role Update [~120ms WSS] [Reactive Strike]',
    antiRolePermUpdate: 'Anti Role Perm Update [~120ms WSS] [Reactive Strike]',
    antiMemberRoleUpdate: 'Anti Member Role Update [~120ms WSS] [Reactive Strike]',
    antiRoleReorder: 'Anti Role Reorder [~120ms WSS] [Reactive Strike]',
    antiChannelCreate: 'Anti Channel Create [~45ms API] [Instant Strike]',
    antiChannelDelete: 'Anti Channel Delete [~45ms API] [Instant Strike]',
    antiChannelUpdate: 'Anti Channel Update [~120ms WSS] [Reactive Strike]',
    antiChannelPermUpdate: 'Anti Channel Perm Update [~120ms WSS] [Reactive Strike]',
    antiChannelReorder: 'Anti Channel Reorder [~120ms WSS] [Reactive Strike]',
    antiChannelNameMod: 'Anti Channel Name Mod [~120ms WSS] [Reactive Strike]',
    antiEmojiCreate: 'Anti Emoji Create [~45ms API] [Instant Strike]',
    antiEmojiDelete: 'Anti Emoji Delete [~45ms API] [Instant Strike]',
    antiEmojiUpdate: 'Anti Emoji Update [~120ms WSS] [Reactive Strike]',
    antiWebhooks: 'Anti Webhooks [~45ms API] [Instant Strike]',
    antiBotAdd: 'Anti Bot Add [~45ms API] [Instant Strike]',
    antiServerUpdate: 'Anti Server Update [~120ms WSS] [Reactive Strike]',
    antiBan: 'Anti Ban [~45ms API] [Instant Strike]',
    antiKick: 'Anti Kick [~45ms API] [Instant Strike]',
    antiUnban: 'Anti Unban [~120ms WSS] [Reactive Strike]',
    antiInvite: 'Anti Invite [~120ms WSS] [Reactive Strike]'
  };
...
export async function getSecurityStatusPanel(guild) {
  ...
  const modLabels = {
    ...
    antiUnban: 'Anti Unban [~120ms WSS] [Reactive Strike]',
    antiInvite: 'Anti Invite [~120ms WSS] [Reactive Strike]',
    antiScheduledEvents: 'Anti Scheduled Events [~120ms WSS] [Reactive Strike]',
    antiMemberPurge: 'Anti Member Purge [~120ms WSS] [Reactive Strike]',
    antiMassBan: 'Anti Mass Ban [~120ms WSS] [Reactive Strike]',
    antiAutomodUpdate: 'Anti Automod Update [~120ms WSS] [Reactive Strike]',
    antiAppCommands: 'Anti App Commands [~120ms WSS] [Reactive Strike]'
  };
