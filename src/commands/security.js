...
export const commands = [
  ...
  // --- QRMANAGER - Quarantine system setup and repair
  {
    name: 'qrmanager',
...
export async function executeQuarantine(guild, targetMember, moderator, reason, durationMs = null, client = null) {
  ...
  try {
    ...
    await quarantineChannel.send(welcomeEmbed).catch((e) => console.error('QUARANTINE_SEND_ERROR:', e));
    ...
    const responseEmbed = cv2.danger(
      ...
      [
        { name: 'Member',      value: `[${targetMember.displayName}](https://discord.com/users/${targetMember.id})`,           inline: true },
...
async function handleRaidMode(guild, moderator, mode) {
  ...
  if (enabled) {
    const resEmbed = cv2.raid(
      ...
      [{ name: 'Enforced by', value: `[${moderator.displayName || moderator.user?.username || 'System'}](https://discord.com/users/${moderator.id || moderator.user?.id})` }]
    );
...
export async function getWhitelistPanel(guild, targetId, type, view = 'info') {
  ...
  const modLabels = {
    antiRoleCreate: 'Anti Role Create [5-10ms WSS] [Reactive Strike]',
    antiRoleDelete: 'Anti Role Delete [1-3ms API] [Instant Strike]',
    antiRoleUpdate: 'Anti Role Update [5-10ms WSS] [Reactive Strike]',
    antiRolePermUpdate: 'Anti Role Perm Update [5-10ms WSS] [Reactive Strike]',
    antiMemberRoleUpdate: 'Anti Member Role Update [5-10ms WSS] [Reactive Strike]',
    antiRoleReorder: 'Anti Role Reorder [5-10ms WSS] [Reactive Strike]',
    antiChannelCreate: 'Anti Channel Create [1-3ms API] [Instant Strike]',
    antiChannelDelete: 'Anti Channel Delete [1-3ms API] [Instant Strike]',
    antiChannelUpdate: 'Anti Channel Update [5-10ms WSS] [Reactive Strike]',
    antiChannelPermUpdate: 'Anti Channel Perm Update [5-10ms WSS] [Reactive Strike]',
    antiChannelReorder: 'Anti Channel Reorder [5-10ms WSS] [Reactive Strike]',
    antiChannelNameMod: 'Anti Channel Name Mod [5-10ms WSS] [Reactive Strike]',
    antiEmojiCreate: 'Anti Emoji Create [1-3ms API] [Instant Strike]',
    antiEmojiDelete: 'Anti Emoji Delete [1-3ms API] [Instant Strike]',
    antiEmojiUpdate: 'Anti Emoji Update [5-10ms WSS] [Reactive Strike]',
    antiWebhooks: 'Anti Webhooks [1-3ms API] [Instant Strike]',
    antiBotAdd: 'Anti Bot Add [1-3ms API] [Instant Strike]',
    antiServerUpdate: 'Anti Server Update [5-10ms WSS] [Reactive Strike]',
    antiBan: 'Anti Ban [1-3ms API] [Instant Strike]',
    antiKick: 'Anti Kick [1-3ms API] [Instant Strike]',
    antiUnban: 'Anti Unban [5-10ms WSS] [Reactive Strike]',
    antiInvite: 'Anti Invite [5-10ms WSS] [Reactive Strike]'
  };
...
export async function getSecurityStatusPanel(guild) {
  ...
  const modLabels = {
    ...
    antiUnban: 'Anti Unban [5-10ms WSS] [Reactive Strike]',
    antiInvite: 'Anti Invite [5-10ms WSS] [Reactive Strike]',
    antiScheduledEvents: 'Anti Scheduled Events [5-10ms WSS] [Reactive Strike]',
    antiMemberPurge: 'Anti Member Purge [5-10ms WSS] [Reactive Strike]',
    antiMassBan: 'Anti Mass Ban [5-10ms WSS] [Reactive Strike]',
    antiAutomodUpdate: 'Anti Automod Update [5-10ms WSS] [Reactive Strike]',
    antiAppCommands: 'Anti App Commands [5-10ms WSS] [Reactive Strike]'
  };
