...
const oldCode = `    // Process link deletion and scam checks (unless it's an emergency bypass)`;

const newCode = `    // --- AUTO-QUOTE CHANNEL SYSTEM ---
    ...
    // Process link deletion and scam checks (unless it's an emergency bypass)`;
