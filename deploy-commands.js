...
const prefixOnlyCommands = ['enuke', 'testbirthday', 'extraowner', 'userblacklist', 'botwhitelist', 'trigger', 'jtcsetup', 'jtcdisable', 'invitesetup', 'invitedisable', 'xpsetup', 'say', 'time', 'bump', 'rate'];
