...
const prefixOnlyCommands = ['enuke', 'testbirthday', 'userblacklist', 'botwhitelist', 'trigger', 'jtcsetup', 'secondaryjtc', 'jtcdisable', 'invitesetup', 'invitedisable', 'xpsetup', 'say', 'time', 'bump', 'rate', 'massdc', 'massmove', 'vcdrag', 'vcdragstop', 'vcdraglist', 'spampermit', 'spamrevoke', 'spamlist', 'cleanbadroles', 'massquarantine', 'massunquarantine', 'scanserver', 'lockapps', 'unlockapps'];
